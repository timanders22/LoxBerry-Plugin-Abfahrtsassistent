<?php
/**
 * Abfahrts-Assistent - Admin-Oberflaeche (v1.3.0)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && (isset($_POST['save']) || isset($_POST['refresh'])) && !isset($_POST['clearlog'])) {
    ...
    $abfcfg['tts'] = [
        ...
        'volume' => max(1, min(100, (int) ($_POST['tts_volume'] ?? 20))),
...
<table class="abf-qt">
<?php $days = [1 => 'Montag', 2 => 'Dienstag', 3 => 'Mittwoch', 4 => 'Donnerstag', 5 => 'Freitag', 6 => 'Samstag', 7 => 'Sonntag'];
...
<tr>
    ...
    <td style="width:105px;"><?= $dayname ?></td>
